...
var requestPath={
		...
		/*查询子组织*/
      	...
      	queryCurrentOrgListByOrgCode:bashPath+"/systemManagerApi/getCurrentOrgListByOrgCode.do",
      	/*新增组织*/
      	...
      	getManagerNodeMemberDuty:bashPath+"/managerNodeConfig/getManagerNodeMemberDuty.do",
      	getMemberDutyAuthRelaseInfo:bashPath+"/managerNodeConfig/getMemberDutyAuthRelaseInfo.do",
