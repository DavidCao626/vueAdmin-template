	...
	<div class="form-container">
		...
		<el-card class="box-card  login-form ">
			<div slot="header" class="clearfix">
		  	...
		  	<br />
			<el-form id="loginForm" :model="ruleLoginForm" status-icon  :rules="rules2" ref="ruleLoginForm" label-width="80px" label-position="left" :action="formurl" method="post">
...
export default {
  data() {
    ...
    return {
      formurl: RquestPathConfig.formregisterUrl,
      serverMessage: {
        exType: 'error',
        message: '登录失败',
        code: '123',
