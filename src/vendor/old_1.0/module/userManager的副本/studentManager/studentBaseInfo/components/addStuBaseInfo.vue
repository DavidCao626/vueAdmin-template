<template>
	<div>
		<el-form size="mini" :model="formStore.formData.data" ref="addForm" :rules="formStore.formData.rules" label-width="100px">
...
export default {
	  ...
	  methods: {
	    ...
	    addStuBaseInfoSubmit: function() {
	      // ref=addForm
	
	      var that = this
	
	      GUtils.post(dataPath.insertStudentBaseInfo, this.formStore.formData.data, function(data) {
	        // 增加成功加载数据
	        that.loading = true
