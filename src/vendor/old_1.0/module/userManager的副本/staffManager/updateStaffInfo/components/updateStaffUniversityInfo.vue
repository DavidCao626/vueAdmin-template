...
export default {
	  ...
	  methods: {
	    ...
	    submitUpdate: function() {
	      ...
	      GUtils.post(dataPath.updateStaffUniversityInfoSelf, this.formStore.formData.data,
	        function(data) {
	          ...
	          GUtils.post(dataPath.queryStaffUniversityInfoById, {
	            ...
	            formDataStore.pushData({
	              ...
	              entranceDate: data2.resBody.baseData.entranceDate,
	              exitDate: data2.resBody.baseData.exitDate,
	              // data.resBody.baseData.id,
	              personnelCode: data2.resBody.baseData.personnelCode,
	              pgposts: data2.resBody.baseData.pgposts,
	              staffCode: data2.resBody.baseData.staffCode,
	              staffJob: data2.resBody.baseData.staffJob,
