	...
	<div>
		<el-form size="mini" :model="formStore.formData.data" ref='form1' :rules='formStore.formData.rules' label-width="100px">
			...
			<el-form-item label="生效时间">
				<el-date-picker format="yyyy 年 MM 月 dd 日" value-format="yyyy-MM-dd" v-model="formStore.formData.data.aEntranceDate" type="date" placeholder="选择日期">
				</el-date-picker>
			</el-form-item>
			<el-form-item label="失效时间">
				<el-date-picker format="yyyy 年 MM 月 dd 日" value-format="yyyy-MM-dd" v-model="formStore.formData.data.aExitDate" type="date" placeholder="选择日期">
				</el-date-picker>
			</el-form-item>
...
// 组织组件
var f_org_code = GStoreFactory.buildSmallCascaderStore(formDataStore.data, 'aOrgCode')
...
GUtils.post(dataPath.queryStaffUniversityInfoById, {
	...
	formDataStore.pushData({
	    ...
	    aEntranceDate: data.resBody.baseData.entranceDate,
	    aExitDate: data.resBody.baseData.exitDate,
	...
	formDataStore.pushData({
	    aOrgCode: data.resBody.aOrgCode
	  })
