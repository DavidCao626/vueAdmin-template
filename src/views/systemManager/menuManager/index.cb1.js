...
var f_role_val = GStoreFactory.buildSmallCheckBoxStore(
  formDataStore.data,
  'role_val'
)
f_role_val.addConf('isButton', false)
var f_vis_list = GStoreFactory.buildSmallSelectStore(
  formDataStore.data,
  'sort_val'
)
...
var n_f_icon = GStoreFactory.buildSmallSelectStore(
  nchild_formDataStore.data,
  'icon'
)
