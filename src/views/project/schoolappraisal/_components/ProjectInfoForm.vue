      ...
      <div slot="panel">
        ...
        <el-form ref="form.expand" label-position="left" :model="form" label-width="110px" style="margin: 20px;">
          ...
          <el-form-item label="截止日期">
            <el-date-picker format="yyyy 年 MM 月 dd 日" value-format="yyyy-MM-dd" v-model="form.expand.dataDue" type="date" placeholder="选择日期">
            </el-date-picker>
          </el-form-item>
...
export default {
  ...
  computed: {
    ...
    ...mapGetters({
      form: state.namespace + "/getSchoolAppraisalProjectFormData",
