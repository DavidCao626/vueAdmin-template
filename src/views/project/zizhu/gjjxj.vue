      ...
      <div>
        <elx-table-layout>
          ...
          <el-table :data="data" style="width: 100%" border size="mini" :default-sort="{ prop: 'stuNo',prop: 'stuName',prop: 'orgName'}">
            ...
            <el-table-column prop="schoolRecommend" :formatter="schoolRecommendFormatter" label="获奖结果">
            </el-table-column>
          </el-table>
...
export default {
  ...
  methods: {
     schoolYearIdChange(v) {
      ...
      this.queryNationalScholarshipProject({
        state: "CO",
        currentPage: "1",
        pageSize: "99999",
        yearType: v
   ...
   refresh() {
    ...
    var requestData = {
      ...
      this.getApi(this.queryNationalScholarshipResult, requestData, (r, vm) => {
        vm.data = r.baseData;
      });
    }
  }
