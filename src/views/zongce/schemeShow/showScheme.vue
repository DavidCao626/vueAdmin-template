<template>
  <div>
    <page>
      ...
      <div slot="panel">
        <div>
          <el-form :model="formInline" class="demo-form-inline" :disabled="true">
    ...
    <div class="approval-panel  footer-toolbar clearfix">
      <div class="footer-toolbar__tools">
        ...
        <el-button type="primary" @click="goDetail">查看分值项</el-button>
      </div>
...
export default {
  ...
  beforeRouteEnter(to, from, next) {
    next(vm => {
      ...
      //----执行查找
      vm
        .getStandardScheme({ schemeId: vm.schemeId })
        .then(response => {
